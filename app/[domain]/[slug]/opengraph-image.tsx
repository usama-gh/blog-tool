...
`;
  ...
  return new ImageResponse(
    (
      <div>
        {data.image !==
        "https://ige9ec25vizexnyy.public.blob.vercel-storage.com/WFClpH0wjj2gu1mBXIlms-MnS5yKErN4UsYCqCMs4tezoQ6G2IXS.png" ? (
          <div tw="flex flex-col justify-center items-center w-full h-screen">
            <img tw="w-full" src={data.image} alt={data.title} />
          </div>
        ) : (
          <div
            style={{ background: "linear-gradient(90deg, #0f172a, #334155)" }}
            tw="flex flex-col justify-center items-start relative  px-24 w-full h-screen "
          >
            ...
            <div tw="flex  flex-col items-start justify-center mt-10 w-full relative">
              <div tw="flex items-center justify-center">
                <img
                  ...
                  alt={data.siteName}
                />
                <p tw="text-xl font-medium text-white uppercase">
                  {data.siteName}
                </p>
              </div>
            ...
            <h3 tw="text-gray-500 text-xl font-bold tracking-normal uppercase absolute bottom-12 right-14">
              Typedd
            </h3>
          </div>
        )}
