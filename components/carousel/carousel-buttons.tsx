...
export const NextButton = ({ enabled, onClick }: any) => (
  <button
    className="h-40 lg:h-[50vh] rounded-l-xl bg-opacity-20 hover:bg-opacity-20 cursor-pointer bg-slate-400 dark:bg-gray-700 dark:bg-opacity-50 fixed z-[1] bottom-0  lg:top-1/2  transform  lg:-translate-y-1/2 right-0 lg:right-0 disabled:opacity-60 disabled:cursor-default"
    onClick={onClick}
    disabled={!enabled}
  >
    <svg
