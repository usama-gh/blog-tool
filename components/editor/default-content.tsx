          ...
          marks: [
            {
              ...
              attrs: {
                ...
                target: "_blank",
                class:
                  "text-slate-400 underline underline-offset-[3px] hover:text-slate-600 transition-colors cursor-pointer text-slate-400 underline underline-offset-[3px] hover:text-slate-600 transition-colors cursor-pointer",
              },
            },
          ],
          text: "Vercel AI SDK",
